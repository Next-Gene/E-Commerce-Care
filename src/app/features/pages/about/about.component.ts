...
@Component({
  selector: 'app-about',
  imports: [MadeByComponent, AboutBackEndComponent, AboutFrontEndComponent, AboutFullStackComponent, AboutProjectManagerComponent, AboutUIUXComponent, AboutPrimeCareComponent],
