...
export const routes: Routes = [
  ...
  },
  {
    path: 'checkout',
    loadComponent: () =>
      import('./features/pages/checkout/ckeckout.component').then(
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './features/pages/checkout/components/paymet/paymet.component'
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './features/pages/checkout/components/form/form.component'
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './features/pages/order-confirmed/order-confirmed.component'
      ).then((c) => c.OrderConfirmedComponent),
  },
  {
